...
I can download a JSON specification the [Vega-Editor](https://vega.github.io/editor/) and save it in `assets/json` folder. 
...
<div class="right">
{% include elements/button.html link="https://github.com/LaraTerpetschnig/LaraTerpetschnig.github.io/blob/main/python_notebooks/inClass_week11.ipynb" text="The Analysis" %}
</div>
